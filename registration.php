...
$sql="INSERT INTO `user_reg`(`name`, `phone`, `email`, `password`, `address`) VALUES ('$fullname','$phone','$email','$password','$address')";
...
<body>
 ...
 <form method="post" action="">
  ...
  <p>if you are already registered ?<a href="login.php">Login</a></p>
 </form>
  </div>
 </div>
 <!-- Optional JavaScript -->
