...
if (isset($_POST['job_submit'])) {
  ...
  $sql = "INSERT INTO `job`(`title`, `description`, `recruiter_name`) VALUES ('$title','$description','$recruiter_name')";
 ...
 <div class="container">
  <div class="row">
   <div class="col-sm-12 mt-3">
    <h1 class="text-center text-info">Available Job Post </h1>
    <a href="addpost.php"
     class="float-right btn btn btn-outline-primary mb-3">Add
     Data</a>
    <?php
        $sql = "SELECT * FROM job";
        $result = mysqli_query($conn, $sql);
